...
| **NHL Analytics** | Data Analytics & Data Engineering | Active | [View Case Study](/nhl-projects) |
| **Stack Overflow NLP** | Natural Language Processing | Closed | [View Case Study](/nlp-project) |
| **Market Prediction** | Machine Learning | Closed | [View Case Study](/market-prediction) |
| **One-Stop-Job-Shop** | AI & Aggregation | Closed | [View Case Study](/one-stop-job-shop) |
...
* <img src="/assets/imgs/bengonzalez.jpg" width="50" style="border-radius:50%; vertical-align:middle;"> [Benjamin Gonzalez](https://github.com/ben-gonz)
...
Successfully predicted outcomes for the 2024-2025 NHL Fantasy Season using custom data pipelines and encoded dictionaries.
